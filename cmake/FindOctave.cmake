...
if(Octave_CONFIG_EXECUTABLE)
  ...
  execute_process(COMMAND ${Octave_CONFIG_EXECUTABLE} --print VERSION
  OUTPUT_VARIABLE Octave_VERSION
  OUTPUT_STRIP_TRAILING_WHITESPACE TIMEOUT 10
  )

  execute_process(COMMAND ${Octave_CONFIG_EXECUTABLE} --print OCTLIBDIR
  ...
  execute_process(COMMAND ${Octave_CONFIG_EXECUTABLE} --print OCTAVE_EXEC_HOME
